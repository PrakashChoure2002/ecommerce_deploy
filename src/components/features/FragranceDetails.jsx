...
const FragranceDetails = () => {
  ...
  const toggleSection = (section) => {
    ...
    const product =  fragranceProducts && fragranceProducts.find(prod => prod.id === productId)
    const [selectedImage, setSelectedImage] = useState(product ? product.image[0].imagemod1 : '');
    // console.log("Product in fraDetails:", product);
  ...
  return product ?(
   ...
   <h6 className=" text-xl font-semibold text-black mt-2">Category: {product.category}</h6>
