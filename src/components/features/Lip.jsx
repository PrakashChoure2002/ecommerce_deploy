...
const Lip = () => {
  ...
  const filteredProducts = lipProducts.filter(product =>
    ...
    <div className='max-[1240px] bg-[#FFFFFF] mt-20 pt-20'>
      <div className='w-full h-[100px] bg-red-200 relative px-20 flex items-center justify-between'>
                ...
                <div className="text-lg">
                    ...
                    <NavLink className={(e) => (e.isActive ? "text-black font-bold text-lg" : "text-black text-lg")} to="/lips">Lip</NavLink>
                </div>
            </div>
            <div>
            <div className="grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-10 gap-2 justify-center mb-4 px-4">
        <button
